...
namespace AdditionTwoNumbersConsumer
{
            ...
            while (!stoppingToken.IsCancellationRequested)
            {
                try
                {
                    ...
                    if (consumeResult != null)
                    {
                        ...
                        string result = $"Consumed addition message: {twoNumbers.FirstNumber} + {twoNumbers.SecondNumber} = {twoNumbers.FirstNumber + twoNumbers.SecondNumber}";
